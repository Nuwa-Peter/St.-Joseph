...
INSERT INTO `announcements` (`id`, `title`, `content`, `user_id`, `start_date`, `end_date`, `created_at`, `updated_at`) VALUES
(1, 'EXAMS', 'prepare for the exams as they will begin next week. thank you!', 4, NULL, NULL, NULL, NULL),
(2, 'report cards', 'the report cards are going to be issued this friday, so pay your balances.', 4, NULL, NULL, '2025-08-13 13:53:53', '2025-08-13 13:53:53');
...
INSERT INTO `attendances` (`id`, `user_id`, `check_in`, `check_out`, `date`, `status`, `recorded_by_id`, `created_at`, `updated_at`) VALUES
(2, 6, NULL, NULL, '2025-08-23', 'present', 1, NULL, NULL);
...
INSERT INTO `book_checkouts` (`id`, `book_id`, `user_id`, `checkout_date`, `due_date`, `returned_date`, `fine_amount`, `checked_out_by_id`, `checked_in_by_id`, `created_at`, `updated_at`) VALUES
(1, 1, 3, '2025-08-13 10:46:36', '2025-08-27 00:00:00', '2025-08-13 07:46:47', NULL, 4, 4, NULL, NULL),
(2, 1, 6, '2025-08-21 19:48:35', '2025-09-04 00:00:00', '2025-08-21 16:50:22', NULL, 1, 1, NULL, NULL);
...
(7, 'S1', '2025-08-13 14:01:16', '2025-08-13 14:01:16'),
(8, 'S2', '2025-08-13 14:08:48', '2025-08-13 14:08:48'),
(9, 'S3', '2025-08-13 14:31:58', '2025-08-13 14:31:58'),
(10, 'S4', '2025-08-16 05:39:25', '2025-08-16 05:39:25'),
(11, 'S5', '2025-08-16 05:39:35', '2025-08-16 05:39:35'),
(12, 'S6', '2025-08-16 05:39:47', '2025-08-16 05:39:47');
...
INSERT INTO `fee_items` (`id`, `fee_structure_id`, `name`, `amount`) VALUES
(1, 1, 'School Fees', 300000.00);
...
INSERT INTO `fee_structures` (`id`, `name`, `description`, `academic_year`, `created_at`, `updated_at`) VALUES
(1, 'S1 Fees', 'this is a test. thanks', '2025', '2025-08-19 10:49:11', '2025-08-19 10:49:11');
...
--
-- Dumping data for table `grade_boundaries`
--

INSERT INTO `grade_boundaries` (`id`, `grading_scale_id`, `grade_name`, `min_score`, `max_score`, `comment`, `created_at`, `updated_at`) VALUES
(1, 1, 'A', 90, 100, 'Pass', '2025-08-16 10:05:32', '2025-08-16 10:05:32'),
(2, 1, 'B', 50, 89, 'Basic', '2025-08-16 10:06:01', '2025-08-16 10:06:01');
...
INSERT INTO `grading_scales` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES
(1, 'Test', 'the system is being tested.', '2025-08-16 10:04:34', '2025-08-16 10:04:34');
...
INSERT INTO `papers` (`id`, `subject_id`, `name`, `exam_type`, `created_at`, `updated_at`) VALUES
(1, 1, 'eot', 'End of Term', '2025-08-18 19:16:05', '2025-08-18 19:16:05');
...
--
-- Dumping data for table `paper_stream_user`
--

INSERT INTO `paper_stream_user` (`id`, `paper_id`, `stream_id`, `user_id`, `created_at`, `updated_at`) VALUES
(1, 1, 13, 7, '2025-08-18 19:18:01', '2025-08-18 19:18:01');
...
INSERT INTO `requisitions` (`id`, `user_id`, `item_name`, `quantity`, `unit_price`, `status`, `notes`, `approved_by`, `approved_at`, `created_at`, `updated_at`) VALUES
(1, 1, 'Reams of Papers', 10, 15000.00, 'pending', 'this is for printing the next term exams. thanks.', NULL, NULL, '2025-08-20 15:27:19', '2025-08-20 12:27:19'),
(2, 1, 'Toner', 5, 15000.00, 'pending', 'this is for printing the next term exams. thanks.', NULL, NULL, '2025-08-20 15:27:19', '2025-08-20 12:27:19');
...
(1, 'school_name', 'ST JOSEPH VOCATIONAL SECONDARY SCHOOL - NYAMITYOBORA'),
(2, 'school_motto', 'WITHOUT JESUS WHAT CAN THE WORLD GIVE YOU!'),
(3, 'school_tel', '0704050747'),
(4, 'school_email', 's.josephthejust@gmail.com'),
(5, 'school_po_box', 'P.O BOX 406 MBARARA'),
(6, 'school_logo_path', 'images/logo.png');
...
INSERT INTO `streams` (`id`, `class_level_id`, `name`, `class_teacher_id`, `created_at`, `updated_at`) VALUES
(8, 7, 'S1A', NULL, '2025-08-13 14:30:35', '2025-08-13 14:30:35'),
(9, 7, 'S1B', NULL, '2025-08-16 05:38:50', '2025-08-16 05:38:50'),
(10, 7, 'S1C', NULL, '2025-08-16 05:39:02', '2025-08-16 05:39:02'),
(11, 8, 'S2A', NULL, '2025-08-16 05:40:00', '2025-08-16 05:40:00'),
(12, 8, 'S2B', NULL, '2025-08-16 05:40:09', '2025-08-16 05:40:09'),
(13, 9, 'S3A', NULL, '2025-08-16 05:40:25', '2025-08-16 05:40:25'),
(14, 9, 'S3B', NULL, '2025-08-16 05:40:34', '2025-08-16 05:40:34'),
(15, 10, 'S4A', NULL, '2025-08-16 05:40:47', '2025-08-16 05:40:47'),
(16, 10, 'S4B', NULL, '2025-08-16 05:40:55', '2025-08-16 05:40:55'),
(17, 11, 'S5 Arts', NULL, '2025-08-16 05:41:33', '2025-08-16 05:41:33'),
(18, 11, 'S5 Sciences', NULL, '2025-08-16 05:41:47', '2025-08-16 05:41:47'),
(19, 12, 'S6 Arts', NULL, '2025-08-16 05:42:03', '2025-08-16 05:42:03'),
(20, 12, 'S6 Sciences', NULL, '2025-08-16 05:42:14', '2025-08-16 05:42:14');
...
(2, 13, 6, '2025-08-16 06:14:24', '2025-08-16 06:14:24');
...
(2, 'ENGLISH', 'ENG', '2025-08-16 05:50:41', '2025-08-16 05:50:41'),
(3, 'PHYSICS', 'PHY', '2025-08-16 06:00:36', '2025-08-16 06:00:36'),
(4, 'CATECHISM', 'CAT', '2025-08-21 06:29:51', '2025-08-21 06:29:51');
...
INSERT INTO `subject_teacher` (`id`, `user_id`, `subject_id`, `created_at`, `updated_at`) VALUES
(1, 7, 1, '2025-08-17 05:08:24', '2025-08-17 05:08:24'),
(2, 7, 3, '2025-08-17 05:08:24', '2025-08-17 05:08:24');
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `other_name`, `unique_id`, `lin`, `date_of_birth`, `role`, `gender`, `phone_number`, `photo`, `status`, `status_change_reason`, `status_changed_at`, `availability`, `id_card_issue_date`, `id_card_expiry_date`, `graduation_year`, `is_alumni`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `student_type`, `username`) VALUES
(1, 'Super', 'Admin', NULL, NULL, NULL, NULL, 'root', 'Male', NULL, NULL, 'active', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'root@school.app', '2025-08-10 03:57:38', '$2y$12$HdTw146Kv75LA2QWxjaAdexvi3N2t0jM85r5sp7nz2F1/jod6OQMu', NULL, '2025-08-10 03:57:38', '2025-08-10 03:57:38', 'day', NULL),
(2, 'Head', 'Teacher', NULL, NULL, NULL, NULL, 'headteacher', 'Male', NULL, NULL, 'active', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'headteacher@school.app', '2025-08-10 03:57:39', '$2y$12$VWmQa5hZc45zopE3HUqZzOlXHomrjEjbUjL9kqa/0nTzajDqHuL.u', NULL, '2025-08-10 03:57:39', '2025-08-10 03:57:39', 'day', NULL),
(3, 'Atwiine', 'Travour', NULL, 'STJ0001', 'UM09872738A8802', NULL, 'student', NULL, NULL, NULL, 'active', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'travour@school.app', NULL, '$2y$12$2Nj4ex.8ADOWDHUNPKmVVebA32Q1JhZAaUm6NQS4.os/Kxlw8/2fa', NULL, '2025-08-11 06:56:11', '2025-08-11 06:56:11', 'day', NULL),
(4, 'Natamba', 'Catherine', NULL, NULL, NULL, NULL, 'root', NULL, NULL, NULL, 'active', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'cathy@school.app', NULL, '$2y$10$3r7ENMameXjm/nqRxSszyeZ/bxQ.oX9S1G/IbFuLStI5J2Ro8V9qK', NULL, NULL, NULL, 'day', NULL),
(5, 'Marisa', 'Nuwahereza', NULL, NULL, NULL, NULL, 'headteacher', NULL, NULL, NULL, 'active', NULL, NULL, NULL, '2025-08-21', '2025-08-31', NULL, 0, 'marisa@school.app', NULL, '$2y$10$z8g3w.17nNzxQRXjVqK86eojBsOtpoXi4ZvZwpQxt.v/0MDFafYkS', NULL, '2025-08-15 20:09:21', '2025-08-15 20:09:21', 'day', 'marisa.nuwahereza'),
(6, 'Samantha', 'Nuwahereza', NULL, NULL, NULL, NULL, 'student', NULL, NULL, NULL, 'active', NULL, '2025-08-18 19:13:48', NULL, '2025-08-16', '2025-08-31', NULL, 0, 'samantha@school.app', NULL, '$2y$10$r3CvGK5r72tu4.jTeHodBODI3HmhykrB776pdkLIi37k4/BgiLe6q', NULL, '2025-08-15 20:18:17', '2025-08-15 20:18:17', 'day', 'sam.nuwa'),
(7, 'Posiano', 'Tugumisirize', '', NULL, NULL, '1991-08-03', 'teacher', 'Male', '0712345678', NULL, 'active', NULL, NULL, 'full-time', NULL, NULL, NULL, 0, 'posiano.teacher@school.app', NULL, '$2y$10$p.SwDRQQ1cXC1lPREV.2KOctB8N4EelHeQr6inODG/8CYIecgtHMW', NULL, '2025-08-17 05:08:24', '2025-08-17 05:08:24', 'day', 'posianotugumisirize');
