...
// Authorization check must be at the top
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['unregister_student'])) {
    ...
    if (empty($reason)) {
        $_SESSION['error_message'] = "A reason is required to unregister a student.";
    } else {
        ...
        if ($stmt->execute()) {
            $_SESSION['success_message'] = "Student has been successfully unregistered.";
        } else {
            $_SESSION['error_message'] = "Failed to unregister student.";
        }
        $stmt->close();
    }
...
<div class="container-fluid">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center my-4">
        <h2 class="mb-3 mb-md-0"><i class="bi bi-people-fill me-2"></i>All Students</h2>
