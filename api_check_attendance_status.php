...
if (!isset($_SESSION["loggedin"]) || !isset($_GET['stream_id']) || !isset($_GET['date'])) {
...
try {
    $stmt = $conn->prepare("SELECT COUNT(id) as count FROM class_attendance WHERE stream_id = ? AND date = ?");
